...
\item Assume that the conspirators are discussing the suspicious topic. \label{cons_susp}
...
and we set $c_i = 0.25$ for those that
...
Suppose the following fact comes into light:
\begin{enumerate}
