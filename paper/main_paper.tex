...
conspiratorial topics to non-conspirators.  We can weight topics that are sent to known non-conspirators less heavily than those not discussed by non-conspirators.

\item Assume that the conspirators are discussing the suspicious topic.  We can weight topics discussed by conspirators more heavily than than other topics. 

\item Assume that the more that a person discusses a suspicious topic the more likely that person is to be a conspirator.  We can give each person a score (reflecting the likelihood that he/she is a conspirator) based on how much they contribute to suspicious topics. 
...
Varying the typo between 1,8,10,111,12,13,14,15 has very little effect on the final output.  A couple of names are occasionally switched, but it does not unmark someone who is suspicious or add in someone who is suspicious.
